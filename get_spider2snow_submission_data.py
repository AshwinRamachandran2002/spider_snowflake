...
def postprocess(args):
    ...
    for instance_id in os.listdir(output_dir):
        ...
        if not os.path.isdir(os.path.join(output_dir, instance_id)):
            print(f"Error: Expected directory, found file - {instance_id}")
            continue
        ...
        if answer_or_path == '':
            ...
            print(f"Copying {answer_or_path} to {submission_dir}")
            try:
            ...
            print(f"Writing answer to {submission_dir}/{instance_id}.txt")
